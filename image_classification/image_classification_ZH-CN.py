...
def flatten(x_tensor):
    ...
    """
    # TODO: Implement Function
    d4 = x_tensor.shape.as_list()
    # d3 = d4[1] * d4[2] * d4[3]
    d3 = np.prod(d4[1:])
    return tf.reshape(x_tensor, [-1, d3])
...
def fully_conn(x_tensor, num_outputs):
    ...
    """
    # TODO: Implement Function
    wd1 = tf.Variable(tf.truncated_normal([x_tensor.get_shape().as_list()[1], num_outputs], mean=0.0, stddev = 0.1))
...
def conv_net(x, keep_prob):
    ...
    conv3 = conv2d_maxpool(x, 128, (3,3), (1,1), (2,2), (2,2))
    ...
    fc = fully_conn(flatten_layer, 256)
...
def print_stats(session, feature_batch, label_batch, cost, accuracy):
    ...
    print('Loss: {:>10.4f} Validation Accuracy: {:.6f}'.format(cost, validation_acc))
