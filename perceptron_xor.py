...
class Perceptron:
    ...
    def __init__(self, weights = np.array([1]), threshold = 1):
        """
...
def EvalNetwork(inputValues, Network):
    ...
    # YOUR CODE HERE
    # p1 = Perceptron(inputValues, 1)
    # p2 = Perceptron(inputValues, -3)
    # a = p1.activate(Network[0][0])
    # b = p2.activate(Network[0][1])
    # p3 = Perceptron(np.array([a,b]), 3)
    # OutputValue = p3.activate(Network[1][0])

    p1 = Perceptron(inputValues, 0.5)
    p2 = Perceptron(inputValues, 1.5)
    a = p1.activate(Network[0][0])
    b = p2.activate(Network[0][1])
    c = p1.activate(Network[0][2])
    p3 = Perceptron(np.array([a,b,c]), 0.5)
    OutputValue = p3.activate(Network[1][0])
